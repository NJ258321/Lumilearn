...
import { Mic, Square, Camera, Flag, Upload, ArrowLeft, ChevronDown, Play, Zap, Type } from 'lucide-react';

interface RecorderProps {
  onBack: () => void;
}

const Recorder: React.FC<RecorderProps> = ({ onBack }) => {
  ...
  return (
    <div className="flex flex-col h-screen bg-[#F7F9FC] text-slate-800 relative font-sans overflow-hidden">
      ...
      <div className="px-6 mb-3 z-10">
        <h1 className="text-3xl font-black tracking-tight text-slate-900">计算机组成原理</h1>
      </div>
