...
export class AuthError extends AppError {
    constructor(code = ErrorCode.NOT_AUTHENTICATED, message) {
        super(code, message);
        this.name = 'AuthError';
    }
}
...
export class DatabaseError extends AppError {
    ...
    constructor(operation, originalError) {
        super(ErrorCode.DATABASE_ERROR, `数据库操作失败: ${operation}`, originalError);
...
export class AIServiceError extends AppError {
    constructor(message, code = ErrorCode.AI_SERVICE_UNAVAILABLE) {
        super(code, message);
...
export class FileError extends AppError {
    constructor(message, code = ErrorCode.FILE_UPLOAD_FAILED) {
        super(code, message);
        this.name = 'FileError';
    }
}
