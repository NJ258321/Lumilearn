...
import { ensureUploadDir, createMulterStorage, createFileFilter, AUDIO_TYPES, IMAGE_TYPES, DOCUMENT_TYPES, MAX_FILE_SIZE, deleteFile, fileExists, getFilePath, getFileUrl, formatFileSize } from '../utils/file.js';
const router = Router();
// 确保上传目录存在
