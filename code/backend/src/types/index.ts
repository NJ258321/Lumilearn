...
/** 掌握度对应的默认状态 */
export const getMasteryStatus = (score: number): KnowledgeStatus => {
  if (score >= MASTERY_THRESHOLDS.MASTERED) return 'MASTERED'
  if (score >= MASTERY_THRESHOLDS.NEED_REVIEW) return 'NEED_REVIEW'
  return 'WEAK'
}
